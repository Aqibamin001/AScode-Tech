...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "AScode Tech — Web Development Studio" },
      { property: "og:description", content: "Fast, editorial websites and web apps built in Lahore for clients worldwide." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://as-code.tech/" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "AScode Tech — Web Development Studio" },
      { name: "twitter:description", content: "Fast, editorial websites and web apps built in Lahore for clients worldwide." },
    ],
    links: [
